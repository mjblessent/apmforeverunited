    ...
    if (isError) {
        return (
            <div role="alert" className="alert alert-error">
                ...
                <p>Account Not Verified! Please try again later</p>
            </div>
        );
    } else {
        return (
                        ...
                        <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                            <div className="card-body">
                                <label className="form-control w-full max-w-xs" >
                                    <p>If you are bringing a plus one, please specify if you are married or significant other. Otherwise, select No plus one</p>
