...
const Signup = () => {
  ...
  <div className="hero-content flex-col ">
    <div className="text-center ">
      ...
      <p className="py-6">Sign up to gain access to excusive features to your personalized one-stop-shop for all your post mission needs such as quick event registration, view your own personal mission history and more!
